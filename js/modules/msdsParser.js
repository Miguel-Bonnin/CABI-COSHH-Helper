...
const hPhraseToGHS = {
    // GHS08 - Health Hazard
    'H350': 'GHS08', 'H351': 'GHS08', 'H340': 'GHS08', 'H341': 'GHS08', // Carcinogen, Mutagen
    'H360': 'GHS08', 'H361': 'GHS08', 'H362': 'GHS08', // Reproductive toxicity
    'H370': 'GHS08', 'H371': 'GHS08', 'H372': 'GHS08', 'H373': 'GHS08', // Organ toxicity
    'H334': 'GHS08', 'H317': 'GHS08', // Respiratory/skin sensitization

    // GHS07 - Harmful/Irritant
    'H302': 'GHS07', 'H312': 'GHS07', 'H332': 'GHS07', // Harmful
    'H315': 'GHS07', 'H319': 'GHS07', 'H320': 'GHS07', // Irritant
    ...
    'H280': 'GHS04', 'H281': 'GHS04', 'H282': 'GHS04', 'H283': 'GHS04',

    // GHS09 - Environmental
    'H400': 'GHS09', 'H410': 'GHS09', 'H411': 'GHS09', 'H412': 'GHS09', 'H413': 'GHS09',
    'H420': 'GHS09', 'H429': 'GHS09'
};
...
export function processMSDSText(text) {
    ...
    if (!chemicalNameValue) {
        const section3Match = text.match(/SECTION 3[^]*?Chemical Name[^]*?(\w[\w\s\-(),.']+?)(?:\s+\d{2,7}-\d{2}-\d|\s+\d{3}-\d{3}-\d|\s+CAS|\s+EC|98-100|$)/im);
    ...
    data.parsedRawPictograms = { value: [...pictograms].join(', '), confidence: pictogramConfidence };
...
Object.defineProperty(window, 'masterParsedMSDSData', {
    get: function() { return masterParsedMSDSData; },
    set: function(data) { masterParsedMSDSData = data; }
});
